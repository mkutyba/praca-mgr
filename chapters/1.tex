...
Dodatkowo zastosowano inne miary skutecznoœci klasyfikatorów, w~nawiasie zawarto symbol którym s¹ oznaczane:
\begin{itemize}
	\item dok³adnoœæ ($A$),
