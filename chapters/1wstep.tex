...
\begin{itemize}
	\item Declarative visitors to ease fine-grained source code mining with full history on billions of AST nodes. \cite{dyer2013declarative}
	\item Method-level bug prediction. \cite{giger2012method}
	\item Comparing fine-grained source code changes and code churn for bug prediction. \cite{giger2011comparing}
	\item Fault-prone Module Prediction Using Version Histories. \cite{hata2012fault}
	\item Reconstructing fine-grained versioning repositories with git for method-level bug prediction. \cite{hata2010reconstructing}
	\item Historage: fine-grained version control system for Java. \cite{hata2011historage}
	\item Bug prediction based on fine-grained module histories. \cite{hata2012bug}
\end{itemize}
...
\noindent TODO Omówienie zawartoœci rozdzia³ów
